      ...
      {sortedListings.length === 0 ? (
        ...
        <div className="space-y-4">
          {sortedListings.map((listing) => (
            <div
              key={listing.id}
              className="bg-white p-4 rounded-lg shadow-md flex items-center justify-between flex-wrap gap-4"
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <Link
                  ...
                  className="px-3 py-1 text-sm font-medium text-blue-600 hover:text-white hover:bg-blue-600 border border-blue-300 rounded-md transition-colors"
                >
                  Redaktə et
                </Link>
                <form action={deleteListing}>
                  ...
                  <button
                    type="submit"
                    className="px-3 py-1 text-sm font-medium text-red-600 hover:text-white hover:bg-red-600 border border-red-300 rounded-md transition-colors"
                  >
                    Sil
                  </button>
                </form>
